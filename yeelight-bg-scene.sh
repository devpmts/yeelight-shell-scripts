...
[[ "$2" = "On" ]] && SC='"method":"bg_set_power","params":["on"]'
[[ "$2" = "Off" ]] && SC='"method":"bg_set_power","params":["off"]'
[[ "$2" = "Sunrise" ]] && SC='"method":"bg_set_scene", "params":["cf",2,1,"50,2,4000,1,900000,2,4000,100"]'
[[ "$2" = "Sunset" ]] && SC='"method":"bg_set_scene", "params":["cf",2,2,"50,2,4000,100,900000,2,4000,1"]'
[[ "$2" = "Sleep" ]] && SC='"method":"bg_set_scene", "params":["cf_",24,2,"4000,2,4000,30,7000,2,4000,10,8000,2,4000,1"]'
[[ "$2" = "Nightlight" ]] && SC='"method":"bg_set_scene","params":["nightlight",'"${3:=10}"']' 
[[ "$2" = "Rainbow" ]] && SC='"method":"bg_set_scene","params":["cf",0,1,"'$(rainbow 3000)'"]'
[[ "$2" = "Disco" ]] && SC='"method":"bg_set_scene","params":["cf",0,1,"'$(rainbow $DISCOSPEED)'"]'
[[ "$2" = "2700" ]] && SC='"method":"bg_set_scene","params":["ct",2700,100]'
[[ "$2" = "4300" ]] && SC='"method":"bg_set_scene","params":["ct",4300,100]'
[[ "$2" = "6500" ]] && SC='"method":"bg_set_scene","params":["ct",6500,100]'
[[ "$2" = "Off1Min" ]] && SC='"method":"bg_set_scene","params":["cf",2,2,"50,1,16777215,100,36000,1,16777215,1"]'
